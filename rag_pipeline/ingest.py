...
Supported file types:
  ...
  .txt            Plain text
  .png / .jpg / .jpeg   Raster images (OCR via pytesseract, mandatory)
  .svg            SVG images (read as raw text)
...
Knowledge sources ingested:
  ...
  5. Any extra files passed via extra_file_paths (.txt / .png / .jpg / .svg).
...
import os as _os
_EMBED_MODEL: str = _os.environ.get("EMBED_MODEL", "Qwen/Qwen3-Embedding-8B")
